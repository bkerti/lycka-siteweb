...
const Footer = () => {
  ...
  return (
    <footer className="bg-lycka-primary text-white pt-12 pb-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8">
          {/* Company Info */}
          <div className="flex flex-col">
            <Link to="/" className="text-2xl font-bold font-heading mb-4">
              LYCKA
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/lycka-home" className="text-gray-300 hover:text-white transition-colors">
                  LYCKA HOME
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">lyckahomed@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mt-0.5 mr-3"
                ...
                <span className="text-gray-300">+237691759654 / +237657241120</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-4 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} LYCKA. Tous droits réservés.
            </p>
